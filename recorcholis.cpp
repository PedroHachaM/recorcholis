...
// CONTINUÉ CON EL CODIGO QUE LLEVAVA EN ARDUINO, TODAVÍA NO VEO TUTORIALES DE C++
...
// se supone que aquí va un for para que con X vueltas del motor avance hasta la siguiente marca...
 ...
 //-------------------------contador de bolis-----------------------------
 if (digitalRead(10) == HIGH){                            // si está activado el sensor 3...
 if (digitalRead(10) == LOW){                             // si ya está desactivado el sensor 3...
     valsensor3++;                                        // suma 1 cuando detecte un bolis
     delay(100);                                          // espera 100 milisegundos
     lcd.setCursor(0,2);                                  // posiciona el cursor en la columna 0   fila 3
     lcd.print("SE HAN HECHO:");                          // imprime en el display
     lcd.setCursor(0,3);                                  // posiciona el cursor en la columna 0   fila 4
     lcd.print(valsensor3);                               // imprime en el display
     lcd.setCursor(3,3);                                  // posiciona el cursor en la columna 3   fila 4
     lcd.print("BOLIS");                                  // imprime en el display
